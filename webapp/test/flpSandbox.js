		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "IFL HelloWorld",
									"targetURL": "#testhellohello01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"testhellohello01-display": {
								"semanticObject": "testhellohello01",
								"action": "display",
								"description": "SAP Fiori Hello World application.",
								"title": "IFL HelloWorld",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=testhello.hello01",
									"url": sap.ui.require.toUrl("testhello/hello01")
								}
							}
						}
					}
